      ...
      <section class="attendance">
          ...
          <div class="containerz">
            ...
            <h1>RECIPIENT FORM </h1>
              <form action="recproc.php" method='post'>
              ...
              <?php if (isset($_GET['error'])) { ?>
                ...
                <div class="user-details">
                  <div class="input-box">
                    ...
                    <input type="text" placeholder="Enter recipients first name" name='fname' required>
                  </div>
                  <div class="input-box">
                    <span class="details">Last Name</span>
                    <input type="text" placeholder="Enter recipients last name" name='lname' >
                  </div>
                  <div class="input-box">
